...
-- 80 agentes NOVO
EXEC Proj.[cp_create_agente] 839684855, 1, 3;
EXEC Proj.[cp_create_agente] 631748029, 2, 3;
EXEC Proj.[cp_create_agente] 683133443, 3, 2;
EXEC Proj.[cp_create_agente] 372273797, 4, 2;
EXEC Proj.[cp_create_agente] 309192268, 5, 2;
EXEC Proj.[cp_create_agente] 963467845, 6, 3;
EXEC Proj.[cp_create_agente] 194114527, 7, 2;
EXEC Proj.[cp_create_agente] 023117550, 8, 2;
EXEC Proj.[cp_create_agente] 859381020, 9, 3;
EXEC Proj.[cp_create_agente] 373381498, 10, 1;
EXEC Proj.[cp_create_agente] 408325564, 11, 3;
EXEC Proj.[cp_create_agente] 235517014, 12, 1;
EXEC Proj.[cp_create_agente] 763670182, 13, 1;
EXEC Proj.[cp_create_agente] 178197861, 14, 1;
EXEC Proj.[cp_create_agente] 619598735, 15, 1;
EXEC Proj.[cp_create_agente] 780482914, 16, 1;
EXEC Proj.[cp_create_agente] 268482736, 17, 1;
EXEC Proj.[cp_create_agente] 289982188, 18, 3;
EXEC Proj.[cp_create_agente] 789300671, 19, 2;
EXEC Proj.[cp_create_agente] 061088842, 20, 1;
EXEC Proj.[cp_create_agente] 897342792, 21, 1;
EXEC Proj.[cp_create_agente] 580727968, 22, 2;
EXEC Proj.[cp_create_agente] 116872071, 23, 3;
EXEC Proj.[cp_create_agente] 727298046, 24, 3;
EXEC Proj.[cp_create_agente] 367583469, 25, 1;
EXEC Proj.[cp_create_agente] 218235937, 26, 1;
EXEC Proj.[cp_create_agente] 633745594, 27, 2;
EXEC Proj.[cp_create_agente] 628692141, 28, 1;
EXEC Proj.[cp_create_agente] 184081898, 29, 3;
EXEC Proj.[cp_create_agente] 371425792, 30, 2;
EXEC Proj.[cp_create_agente] 825045183, 31, 3;
EXEC Proj.[cp_create_agente] 478038352, 32, 3;
EXEC Proj.[cp_create_agente] 631724018, 33, 3;
EXEC Proj.[cp_create_agente] 036333143, 34, 2;
EXEC Proj.[cp_create_agente] 722045350, 35, 3;
EXEC Proj.[cp_create_agente] 697019923, 36, 2;
EXEC Proj.[cp_create_agente] 206033189, 37, 2;
EXEC Proj.[cp_create_agente] 037541416, 38, 3;
EXEC Proj.[cp_create_agente] 379283802, 39, 2;
EXEC Proj.[cp_create_agente] 905778131, 40, 2;
EXEC Proj.[cp_create_agente] 112133071, 41, 2;
EXEC Proj.[cp_create_agente] 581353194, 42, 3;
EXEC Proj.[cp_create_agente] 648851106, 43, 2;
EXEC Proj.[cp_create_agente] 372729290, 44, 1;
EXEC Proj.[cp_create_agente] 119650587, 45, 1;
EXEC Proj.[cp_create_agente] 427825540, 46, 1;
EXEC Proj.[cp_create_agente] 499800448, 47, 2;
EXEC Proj.[cp_create_agente] 470006152, 48, 2;
EXEC Proj.[cp_create_agente] 646672914, 49, 2;
EXEC Proj.[cp_create_agente] 852588589, 50, 3;
EXEC Proj.[cp_create_agente] 183565198, 51, 1;
EXEC Proj.[cp_create_agente] 667159285, 52, 2;
EXEC Proj.[cp_create_agente] 757844249, 53, 1;
EXEC Proj.[cp_create_agente] 895502376, 54, 1;
EXEC Proj.[cp_create_agente] 212754060, 55, 1;
EXEC Proj.[cp_create_agente] 208507356, 56, 2;
EXEC Proj.[cp_create_agente] 892976099, 57, 3;
EXEC Proj.[cp_create_agente] 139929176, 58, 2;
EXEC Proj.[cp_create_agente] 839752333, 59, 2;
EXEC Proj.[cp_create_agente] 172857127, 60, 2;
EXEC Proj.[cp_create_agente] 331151250, 61, 2;
EXEC Proj.[cp_create_agente] 488288207, 62, 2;
EXEC Proj.[cp_create_agente] 308240158, 63, 2;
EXEC Proj.[cp_create_agente] 036695807, 64, 1;
EXEC Proj.[cp_create_agente] 395665657, 65, 3;
EXEC Proj.[cp_create_agente] 840610452, 66, 1;
EXEC Proj.[cp_create_agente] 429994442, 67, 3;
EXEC Proj.[cp_create_agente] 627811395, 68, 2;
EXEC Proj.[cp_create_agente] 552853479, 69, 1;
EXEC Proj.[cp_create_agente] 698738501, 70, 2;
EXEC Proj.[cp_create_agente] 923840584, 71, 3;
EXEC Proj.[cp_create_agente] 394182748, 72, 2;
EXEC Proj.[cp_create_agente] 373747923, 73, 3;
EXEC Proj.[cp_create_agente] 109615030, 74, 2;
EXEC Proj.[cp_create_agente] 883600454, 75, 1;
EXEC Proj.[cp_create_agente] 683583164, 76, 1;
EXEC Proj.[cp_create_agente] 602333088, 77, 3;
EXEC Proj.[cp_create_agente] 234987319, 78, 1;
EXEC Proj.[cp_create_agente] 399174182, 79, 1;
EXEC Proj.[cp_create_agente] 121658580, 80, 3;
