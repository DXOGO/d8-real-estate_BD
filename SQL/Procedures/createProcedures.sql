...
@nif INT, @nome VARCHAR(50), @birth DATE, @email VARCHAR(50), @morada VARCHAR(50), @num_tlm INT
AS
...
@nif INT, @nome VARCHAR(50), @birth DATE, @email VARCHAR(50), @morada VARCHAR(50), @num_tlm INT, @agente_nif INT
AS
	-- se a pessoa já for proprietario, então já existe na tabela pessoa e não é preciso inserir
